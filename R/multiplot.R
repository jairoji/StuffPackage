...
#' @param cols:   Number of columns in layout, layout: A matrix specifying the layout. If present, 'cols' is ignored.
#' @keywords ggplot, multiplot
#' @export
#' @examples http://www.cookbook-r.com/Graphs/Multiple_graphs_on_one_page_(ggplot2)/
